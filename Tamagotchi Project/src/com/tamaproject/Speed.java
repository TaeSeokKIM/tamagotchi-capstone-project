...
//public class PathModifierExample extends BaseExample {
	...
	public Engine onLoadEngine() {
		...
		return new Engine(new EngineOptions(true, ScreenOrientation.LANDSCAPE, new RatioResolutionPolicy(cameraWidth, cameraHeight), this.mCamera));
	}
	...
	public void onLoadResources() {
		...
		this.mGrassBackground = new RepeatingSpriteBackground(cameraWidth, cameraHeight, this.mEngine.getTextureManager(), new AssetBitmapTextureAtlasSource(this, "background_grass.png"));
