...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void createDatabase() throws IOException { 
		...
		if(dbExist) {
			...
			/* By calling this method and empty database will be created into the default system path of the application
			 * so we can overwrite the database with the application*/
	...
	/**
	 * Copies your database from the local assets-folder to the just created empty database in teh
